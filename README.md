...
The ```README.md``` for each lesson-folder contains detailed notes on all of the lectures to serve as a reference for myself  when trying to recall or understand the concepts described in the course.
